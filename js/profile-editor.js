...
function checkAllElements ()
{
  ...
  if (firstName == "" || lastName == "" || trackName == "" || birthdate == "" || address == "" || qualification == "" || email == "")
  {
    ...
    if (firstName == "")
    {
      document.getElementById('1').textContent = "Fill First Name";
    }else
    {
    ...
    if (lastName == "")
    {
      document.getElementById('2').textContent = "Fill Last Name";
    }else
    {
    ...
    if (trackName == "")
    {
      document.getElementById('3').textContent = "Fill Track Name";
    }else
    {
    ...
    if (birthdate == "")
    {
      document.getElementById('4').textContent = "Fill Birthdate";
    }else
    {
    ...
    if (address == "")
    {
      document.getElementById('5').textContent = "Fill The Address";
    }else
    {
    ...
    if (qualification == "")
    {
      document.getElementById('6').textContent = "Fill Qualification";
    }else
    {
    ...
    if (email == "")
    {
      document.getElementById('7').textContent = "Fill Email Address";
    }else
    {
